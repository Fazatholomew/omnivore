...
if __name__ == '__main__':
  ...
  for opp in load_dummy_query_all('dada FROM Opportunity fsfsf')['records']:
    ...
    print(f"Id = {opp['Id']} Email = {accs[opp['AccountId']]['PersonEmail'] if opp['AccountId'] in accs else ''} Phone = {accs[opp['AccountId']]['Phone'] if opp['AccountId'] in accs else ''} Account ID = {opp['AccountId']} HPC ID = {opp['ID_from_HPC__c']}")
  # print(accounts)
