...
HPC_CITY_TABLE = {
    ...
    NEEECO_ACCID: ["cambridge", "chelsea", "revere", "winthrop", "quincy", "randolph"],
    REVISE_ACCID: ["brockton", "everett", "lynn", "swampscott", "sharon", "shelburne"],
    VHI_ACCID: [
        "andover",
        "lawrence",
        "north andover",
